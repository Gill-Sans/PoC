...
public class AskStoreNameTool {
    ...
    public AskStoreNameTool(TwilioResponseBuilder twilioResponseBuilder, LanguageProperties languageProperties) {
    ...
    public String askStoreName(Say.Language language) {
        String message = ToolLanguageUtil.getMessage(languageProperties.getAskStoreName(), language);
